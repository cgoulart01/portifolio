...
<Infos>
        ...
        <Intro>
        <Link href="https://www.linkedin.com/in/cgoulart01/"  ><a className="link" target='_blank'> <BsLinkedin/> <strong className='strong'>Linkedin:</strong>{"https://www.linkedin.com/in/cgoulart01/"}</a></Link> 
            <br/>
